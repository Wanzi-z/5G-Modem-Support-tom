...
#modem_config为wwan_ifname去除wwan_5g_后的部分加上modem
[ -n $wwan_ifname ] && modem_config=$(echo $wwan_ifname | sed 's/wwan_5g_//g')
[ -z $modem_config ] && modem_config=modem0 || modem_config=modem$modem_config
